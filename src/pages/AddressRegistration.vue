            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
              <div class="form-items">
                ...
                <div class="form-input-box">
                  ...
                  />
                  <i
                    v-show="firstNameValue"
                    @click="clearInput('firstNameValue')"
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
              <div class="form-items">
                ...
                <div class="form-input-box">
                  ...
                  />
                  <i
                    v-show="lastNameValue"
                    @click="clearInput('lastNameValue')"
                    class="bi bi-x-circle-fill"
                  ></i>
                </div>
              ...
              <div class="form-items">
                ...
                <div class="form-input-box">
                  <input
                    ...
                    v-model.trim="addressValue"
                    class="form-input"
                    type="text"
                  />
                  <i
                    v-show="addressValue"
                    @click="clearInput('addressValue')"
                    class="bi bi-x-circle-fill"
                  ></i>
                </div>
...
const validateMobile = () => {
  isMobileValid.value =
    mobileValue.value.length === 11 && /^09\d{9}$/.test(mobileValue.value);
};

const validatePhone = () => {
  isPhoneValid.value =
    phoneValue.value.length === 11 && /^\d+$/.test(phoneValue.value);
};
